...
module "avd-hostpool-module" {
  ...
  location = "uk south"
  dns      = "10.10.10.1"
  hub_vnetid = "/subscriptions/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/resourceGroups/scsavdlab-infra/providers/Microsoft.Network/virtualNetworks/Region1-vnet1-hub"
